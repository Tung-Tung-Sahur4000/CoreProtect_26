...
public final class BlockGroup {
    ...
    /* Low-value vegetation that gets created/destroyed constantly (mob pathfinding,
       water flow, growth ticks, walking). Logging it wastes disk and clutters
       /co lookup output without any anti-grief value. Populated at runtime so
       names absent on older servers are skipped. */
    public static Set<Material> LOG_SKIP = new HashSet<>();
